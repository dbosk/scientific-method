...
\begin{frame}
  ...
  \uncover<+>{%
    \begin{remark}
      \begin{itemize}
        \item I'm evaluating whether I can use teaching part for assessment.
        \item That way you don't need to do the project.
      \end{itemize}
    \end{remark}
  }
\end{frame}
...
\begin{frame}
  \begin{block}{Giving the course}
    \begin{itemize}
      \item Given twice pre year, for now.
      \item If you don't finish, you can try again next round.
      \item Next will be either period 3 or 4, depending on turnout.
    \end{itemize}
  \end{block}
\end{frame}
}
